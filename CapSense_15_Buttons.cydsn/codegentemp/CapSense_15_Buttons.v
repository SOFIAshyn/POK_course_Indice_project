// ======================================================================
// CapSense_15_Buttons.v generated from TopDesign.cysch
// 12/24/2019 at 17:10
...
module CapSense_P4_v5_0_0 ;
    ...
    defparam CSD.sensors_count = 15;
    defparam CSD.shield_as_sense = 0;
    defparam CSD.shield_count = 1;
    defparam CSD.tx_count = 1;

	wire [14:0] tmpOE__Sns_net;
	wire [14:0] tmpFB_14__Sns_net;
	wire [14:0] tmpIO_14__Sns_net;
	wire [0:0] tmpINTERRUPT_0__Sns_net;
	electrical [0:0] tmpSIOVREF__Sns_net;

	cy_psoc3_pins_v1_10
		#(.id("1bfec5ca-319e-4770-b978-65591dcda6e4/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("Button0_Sns0,Button1_Sns0,Button2_Sns0,Button3_Sns0,Button4_Sns0,Button5_Sns0,Button6_Sns0,Button7_Sns0,Button8_Sns0,Button9_Sns0,Button10_Sns0,Button11_Sns0,Button12_Sns0,Button13_Sns0,Button14_Sns0"),
		...
		Sns
		 (.oe(tmpOE__Sns_net),
		  .y({15'b0}),
		  .fb({tmpFB_14__Sns_net[14:0]}),
		  .analog({Net_2[14:0]}),
		  .io({tmpIO_14__Sns_net[14:0]}),
	...
	assign tmpOE__Sns_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{15'b111111111111111} : {15'b111111111111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("1bfec5ca-319e-4770-b978-65591dcda6e4/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("1bfec5ca-319e-4770-b978-65591dcda6e4/a8285cdc-5e81-40c0-8036-58ea5f8c1102"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("96cd28d5-5fc1-4ba4-9f4f-ed93d7d475ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
