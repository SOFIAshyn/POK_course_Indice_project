...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=0, TCCountingModes=0, TCCountMode=0, TCCountPresent=true, TCInterruptMask=0, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=true, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=Counter_Motor_Steps, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_Motor_Steps, CY_INSTANCE_SHORT_NAME=Counter_Motor_Steps, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Counter_Motor_Steps, )
...
>>>>>>> 2a53f4dd5b08b7201acfd3c35e4b74087265cf45
	...
	cy_psoc3_pins_v1_10
		#(.id("8d8eb902-4f31-4605-bdd2-5e1787360291"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_EN_net;
	wire [0:0] tmpFB_0__Pin_EN_net;
	wire [0:0] tmpIO_0__Pin_EN_net;
	wire [0:0] tmpINTERRUPT_0__Pin_EN_net;
	electrical [0:0] tmpSIOVREF__Pin_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("0b86da61-f4a7-4b80-9f19-2d3cf080226d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_EN
		 (.oe(tmpOE__Pin_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_EN_net[0:0]}),
		  .io({tmpIO_0__Pin_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_EN_net),
		  .interrupt({tmpINTERRUPT_0__Pin_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
...
>>>>>>> 2a53f4dd5b08b7201acfd3c35e4b74087265cf45
    ...
    TCPWM_P4_v2_10_1 Counter_Motor_Steps (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(Net_2828),
...
>>>>>>> 2a53f4dd5b08b7201acfd3c35e4b74087265cf45
    ...
    CyControlReg_v1_80 Motor_Control_Reg (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Motor_Control_Reg.Bit0Mode = 0;
    defparam Motor_Control_Reg.Bit1Mode = 0;
    defparam Motor_Control_Reg.Bit2Mode = 0;
    defparam Motor_Control_Reg.Bit3Mode = 0;
    defparam Motor_Control_Reg.Bit4Mode = 0;
    defparam Motor_Control_Reg.Bit5Mode = 0;
    defparam Motor_Control_Reg.Bit6Mode = 0;
    defparam Motor_Control_Reg.Bit7Mode = 0;
    defparam Motor_Control_Reg.BitValue = 0;
    defparam Motor_Control_Reg.BusDisplay = 0;
    defparam Motor_Control_Reg.ExtrReset = 0;
    defparam Motor_Control_Reg.NumOutputs = 1;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_2823)
    begin
        cy_tff_1 <= Net_2822^Net_2828;
    end
    assign Net_2828 = cy_tff_1;
    // -- TFF End --

    assign Net_2822 = 1'h1;


    assign Net_2834 = ~Net_2852;
	...
	cy_psoc3_pins_v1_10
		#(.id("80ff5e45-f161-4b71-bf38-2e371d8108c4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("12f0f4b8-bb6a-476f-9e4e-3dc45fceb76e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
